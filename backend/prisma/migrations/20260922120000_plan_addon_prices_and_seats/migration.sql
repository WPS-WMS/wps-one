...
ALTER TABLE "Tenant" ADD COLUMN IF NOT EXISTS "subscriptionAddonSharepointUsers" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Tenant" ADD COLUMN IF NOT EXISTS "subscriptionAddonComercialUsers" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "Tenant" ADD COLUMN IF NOT EXISTS "subscriptionAddonRhUsers" INTEGER NOT NULL DEFAULT 0;
