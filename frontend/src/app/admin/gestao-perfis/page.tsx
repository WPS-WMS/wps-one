...
const FEATURES: Feature[] = [
  ...
  { id: "hora-banco.verTodos.editar", label: "Banco de horas \u003e Ver banco de horas de todos os usuários \u003e Editar", section: "Banco de horas" },
  ...
  { id: "financeiro.projetos", label: "Financeiro \u003e Receita de projetos (menu)", section: "Financeiro" },
  { id: "financeiro.projetos.receitas", label: "Financeiro \u003e Receita de projetos \u003e Receitas", section: "Financeiro" },
  ...
  FEATURES.forEach((f) => {
    switch (f.id) {
      ...
      case "financeiro.aprovarReembolso":
        initial[f.id] = { ...d(), FINANCEIRO: "allow", GESTOR_PROJETOS: "allow" };
        break;
      case "financeiro":
