...
/** Painel extra largo (ex.: cliente com dados financeiros). */
export const formModalPanelExtraWideClass =
  "bg-[color:var(--surface)] rounded-2xl border border-[color:var(--border)] w-full max-w-4xl max-h-[min(92vh,960px)] shadow-lg flex flex-col overflow-hidden";
