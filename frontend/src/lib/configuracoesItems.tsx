...
export function getConfiguracoesItems(basePath: "/admin" | "/gestor" | "/consultor"): ConfiguracaoItem[] {
  const items: ConfiguracaoItem[] = [
    ...
    },
    {
      ...
      title: "Reembolsos",
      description: "Tipos, limites por projeto e regras das solicitações de reembolso.",
      icon: Receipt,
      section: "financeiro",
    },
    {
      ...
      description: "Dados fiscais, endereço e conta bancária para notas de débito e invoices.",
      icon: Building2,
      section: "financeiro",
    },
    {
      ...
      description: "Classificação usada no cadastro de fornecedores e parceiros.",
      icon: Tags,
      section: "financeiro",
    },
    {
      ...
      description: "Áreas da empresa para alocar despesas e receitas.",
      icon: Layers,
      section: "financeiro",
    },
    {
      ...
      description: "Contas de receita e despesa usadas nos lançamentos e relatórios.",
      icon: ListTree,
      section: "financeiro",
    },
    {
    ...
    },
    {
      ...
      description: "Classificação vinculada aos fornecedores (PJ, CLT, Cooperado, etc.).",
      icon: FileText,
      section: "financeiro",
    },
    {
